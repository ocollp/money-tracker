 ...
 *
 * Fixed amount: Vivienda personal = 150000. All other amounts blank.
 *
 * Install (in Andrea's spreadsheet only — separate from Diego i Montse):
 * 1. Open Andrea spreadsheet
...
/** Fixed rows for Andrea. Amount null = leave blank. */
var TEMPLATE = [
  { type: 'Cash', category: 'Cuenta corriente', entity: 'BBVA', amount: null },
  { type: 'Cash', category: 'Cuenta corriente', entity: 'Revolut', amount: null },
  ...
  { type: 'Cash', category: 'Efectivo', entity: 'Efectivo', amount: null },
...
function onOpen() {
  SpreadsheetApp.getUi()
    .createMenu('Dades')
    .addItem('Afegir mes següent amb plantilla', 'addNewMonthAndrea')
    .addToUi();
}

function addNewMonthAndrea() {
